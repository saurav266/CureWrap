...
export default function CureWrapAboutV2() {
  ...
  return (
    <div className="bg-white text-gray-800 antialiased">
      ...
      {/* WHO WE ARE */}
      <section className="max-w-7xl mx-auto px-6 py-20 -mt-6"> {/* negative top to tuck under the wave */}
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            >
              At <span className="font-semibold" style={{ color: brandGreen }}>CureWrap</span>, we design clean, effective
              orthotic support that empowers everyday movement. We combine deep
              research with premium materials so comfort becomes the background
              of life—not the focus.
            </motion.p>
          </div>
      ...
      <div className="w-full">
        <svg viewBox="0 0 1440 80" className="w-full h-[80px]" preserveAspectRatio="none">
          <path d="M0,24 C300,120 600,0 720,24 C840,48 1140,0 1440,24 L1440 80 L0 80 Z" fill="#f8fafc" />
        </svg>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ x: -20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
            <p className="text-gray-700 text-lg leading-relaxed">
              CureWrap started from a simple need: a comfortable, effective brace
              that actually helped people move better. That led to months of
              research, prototypes and real-world testing.
            </p>
          </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Every CureWrap product is engineered with human biomechanics in mind —
              durable materials, precise fit, and everyday comfort.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              To craft supportive products that help people stay active, built on research and real feedback.
            </p>
          </div>
          <motion.img src={ourMission} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="rounded-2xl shadow-lg w-full h-80 object-cover" />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <p className="text-lg leading-relaxed">
              We test everything — durability, fit, sweat-resistance, and function.
            </p>
